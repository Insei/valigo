...
// type numBuilder[T int | *int | int8 | *int8 | int16 | *int16 | int32 | *int32 | int64 | *int64 |
//
...
//	}
//
//	func maxT[T int | int8 | int16 | int32 | int64 | uint | uint8 | uint16 | uint32 | uint64](valuePtr *T, valuePtr2 **T, maxT int) (any, bool) {
//		if valuePtr == nil && *valuePtr2 == nil {
//			return 0, false
//		}
//		if valuePtr != nil {
//			return *valuePtr, T(maxT) > *valuePtr
//		}
//		return **valuePtr2, T(maxT) > **valuePtr2
//	}
//
...
//func (i *numBuilder[T]) Max(maxNum int) ValueConfigurator[T] {
...
//func (i *numBuilder[T]) Min(minNum int) ValueConfigurator[T] {
//	i.appendFn(i.field, func(ctx context.Context, h shared.Helper, value any) []shared.Error {
//		isValid := true
//		var v any
//		switch typed := value.(type) {
...
//func (i *numBuilder[T]) Required() ValueConfigurator[T] {
//	i.appendFn(i.field, func(ctx context.Context, h shared.Helper, value any) []shared.Error {
//		isValid := true
//		var v any
//		switch typed := value.(type) {
...
//func (i *numBuilder[T]) AnyOf(allowed ...int) ValueConfigurator[T] {
//	i.appendFn(i.field, func(ctx context.Context, h shared.Helper, value any) []shared.Error {
//		isValid := true
//		var v any
//		switch typed := value.(type) {
...
//func (i *numBuilder[T]) AnyOfInterval(begin, end int) ValueConfigurator[T] {
//	i.appendFn(i.field, func(ctx context.Context, h shared.Helper, value any) []shared.Error {
//		isValid := true
//		var v any
//		switch typed := value.(type) {
...
//func (i *numBuilder[T]) Custom(f func(ctx context.Context, h *shared.FieldCustomHelper, value *T) []shared.Error) ValueConfigurator[T] {
...
//func (i *numBuilder[T]) When(whenFn func(ctx context.Context, value *T) bool) ValueConfigurator[T] {
//	if whenFn == nil {
//		return i
//	}
