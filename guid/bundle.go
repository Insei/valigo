...
type baseConfiguratorParams[T uuid.UUID] struct {
	Field    fmap.Field
	Helper   shared.Helper
	AppendFn func(fn shared.FieldValidationFn)
}

func newBaseConfigurator[T uuid.UUID](p baseConfiguratorParams[uuid.UUID], derefFn func(value any) (uuid.UUID, bool)) *baseConfigurator {
...
func (i *UUIDBundle) UUID(fieldPtr any) BaseConfigurator {
	...
	return newBaseConfigurator(baseConfiguratorParams[uuid.UUID]{
		Field:  field,
		Helper: i.h,
		AppendFn: func(fn shared.FieldValidationFn) {
			i.appendFn(field, fn)
